...
if (((ctr < 6) && (cpulow < 1) && ((bonchn > 2) || magchn > 2)))//new
{
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
...
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1))
{
printf("     And you have a Special Round Chain Record!\n");
++new1;
}
...
{
diceE = (rand() % 26 + diflev + diceR) + 1;//maybe 28 24 26 33 24 26 22 26
}
else
{
if ((choice == 'n') && (choice != 'm') && (choice != 's'))
...
diceS1 = (rand() % 18) + 1;//6 10 12 18 22 18
...
if ((emagsup6 < 1) && (diceR < 1))
diceS2 = (rand() % 22) + 1;//6 10 12 20 24
...
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 54 + diflev) + 1; ///54 52 51 50 48 52
}
...
if ((diceF > 29) && (diceR < 1))
diceS3 = (rand() % 28) + 1;//8 12 14 24 26
...
diceC = (rand() % 92 + diflev + diceR) + 1; //86 87 88 92 (not 86 higher) 90
}
...
if (((diceM > 40) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && (hypsp2 > 0) && (spatt2 > 0) && (diflev > 6) && (diceR < 1))///enspcom6
emagsup6 = 1;
diceZB = (rand() % 10) + 1;
diceZC = (rand() % 10) + 1;
